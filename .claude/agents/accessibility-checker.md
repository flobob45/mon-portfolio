...
description: Expert en accessibilité web (WCAG 2.1). Utiliser pour auditer
l'accessibilité du site. Déclencher proactivement après des modifications HTML.
...
- Le ratio de contraste texte/fond est d'au moins 4.5:1 (texte normal) et 3:1 (texte
large)
